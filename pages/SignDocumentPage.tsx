...
const SignDocumentPage: React.FC = () => {
  ...
  const signMutation = useMutation<void, AxiosError<{ message: string }>, { strokes: any[]; signingToken: string }>({
                ...
                <div className="flex-grow overflow-y-auto min-h-0">
                  ...
                  {view === 'sign' && (
                      <div className="flex flex-col h-full">
                        <p className="text-dark-text-secondary mb-2 text-center">Please sign in the box below.</p>

                        <div className="flex justify-center items-center gap-x-4 gap-y-2 mb-4 flex-wrap">
                          <div className="flex items-center gap-2">
                            <label htmlFor="strokeColor" className="text-dark-text-secondary text-sm">Color:</label>
                            <input
                                type="color"
                                id="strokeColor"
                                value={strokeColor}
                          ...
                          <div className="flex items-center gap-2">
                            <label htmlFor="strokeWidth" className="text-dark-text-secondary text-sm">Width:</label>
                            <input
                                type="range"
                                id="strokeWidth"
                                min="1"
                            ...
                            />
                            <span className="text-dark-text-secondary w-8 text-center">{strokeWidth}px</span>
                          </div>
                        </div>

                        <div className="flex-grow w-full min-h-64">
                          <SignaturePad ref={signaturePadRef} strokeColor={strokeColor} strokeWidth={strokeWidth}/>
                        </div>
