...
export type SigningErrorCodeType =
...
export const SigningErrorMessage: Record<SigningErrorCodeType, string> = {
    ...
    SESSION_DEVICE_MISMATCH:
        "Device verification failed. This session was created on a different device.",
    ...
    TOO_MANY_ATTEMPTS:
        "Too many signing attempts. Please create a new session.",
