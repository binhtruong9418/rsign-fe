...
## RSign Design System (Project Specific)

For this project, strictly adhere to the following design system configuration.
...
### 2. Color Palette (Tailwind v4 Variables)

- **Primary (Blue)**: `bg-primary-600` (Main), `bg-primary-700` (Hover), `text-primary-600`
- **Secondary (Slate)**: `bg-secondary-50` (Background), `text-secondary-900` (Headings), `text-secondary-500` (Muted)
- **Accent (Green)**: `text-accent-600` (Success/Signed), `bg-accent-500` (Buttons)

### 3. Reusable Components

Use these utility classes defined in `src/index.css` instead of raw Tailwind classes:

| Component            | Class Name       | Description                                        |
| -------------------- | ---------------- | -------------------------------------------------- |
| **Primary Button**   | `.btn-primary`   | Blue background, white text, hover effects         |
| **Secondary Button** | `.btn-secondary` | White background, slate border, hover effects      |
| **Accent Button**    | `.btn-accent`    | Green background, white text (for success actions) |
| **Card**             | `.card`          | White background, border, shadow, rounded-xl       |
| **Input Field**      | `.input-field`   | Styled text input with focus rings                 |
| **Label**            | `.label-text`    | Standard label styling                             |

### 4. Implementation Rules

- **Tailwind v4**: Use the new CSS variable-based configuration. Do not use `@apply` in `tailwind.config.js`.
